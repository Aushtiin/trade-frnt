    ...
    <ListGroup.Item key={comment._id}>
      <>
        ...
        <div className="reply">
          ...
          {comment.replies.length > 0 && <span onClick={() => setShowReplies(prev => !prev)} id='show'>show replies</span>}
        </div>
        {showReplies && 
          <ListGroup>
            ...
            </ListGroup>}
        {
          reply && <div>
            <Form onSubmit={submit}>
              <Form.Control value={body} onChange={e => setBody(e.target.value)} type="text" />
